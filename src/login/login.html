...
<body>
        ...
        <div class="login-form">
            ...
            <div class="input-info-login">
                <input type="text" class="phone" placeholder="Số điện thoại/Email &ast;" required>           
                <div>
                ...
                <button class="v6_684"><span class="v6_685">ĐĂNG NHẬP</span></button>
